// 尾灯拖尾验证：夜晚驾驶 918，确认左右各 3 条不同宽度条带覆盖尾灯四边形
(async () => {
  ...
  try {
    ...
    return {
      ok: true,
      tailLightLocalCount: Game.car.tailLightLocal ? Game.car.tailLightLocal.length : -1,
      tailLightWidths: Game.car.tailLightWidths || null,
